...
import { PrescricaoManipuladosTab } from "@/components/tabs/PrescricaoManipuladosTab";
...
const TABS = [
  ...
  { key: "manipulados",   label: "Prescrição Manipulados",  icon: "⚗️",  title: "Prescrição de Manipulados", Component: PrescricaoManipuladosTab },
